...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    benefits: Attribute.Component<'list.detail-list', true> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiExperienceExperience extends Schema.CollectionType {
  ...
  attributes: {
    ...
    description_two_title: Attribute.String &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    slug: Attribute.UID<'api::experience.experience', 'name'> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiPagePage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    advantages: Attribute.Component<'list.detail-list', true> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
